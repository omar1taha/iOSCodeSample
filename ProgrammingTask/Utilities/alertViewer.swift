...
class AlertViewer: NSObject {
    ...
    func showAlertView(withMessage msg: String,onController controller: UIViewController) {
        alert = UIAlertController(title: "Barq", message: msg, preferredStyle: UIAlertController.Style.alert)
    ...
    func showAlertOutsideController(msg: String) {
        ...
        let alert = UIAlertController(title: "Barq", message: msg, preferredStyle: .alert)
